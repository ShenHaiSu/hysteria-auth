...
<template>
  <div
    class="bg-surface-0 dark:bg-surface-900 rounded-lg shadow-sm border border-surface-200 dark:border-surface-700 overflow-hidden p-4"
  >
    <DataTable
      :value="nodes"
      :loading="loading"
      ...
      :pt="{
        header: {
          class:
            'bg-surface-50 dark:bg-surface-800/50 border-b border-surface-200 dark:border-surface-700 px-4 py-3',
        },
        column: {
          headerCell: {
            class:
